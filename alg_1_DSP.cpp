...
private:
	...
	// Токи
	float *in_val_I	[3][HBuffSize];	///< Указатели на выборки \c HBuffSize значений фазных токов
	string in_name_I[3][HBuffSize];
	// Напряжения
	float *in_val_U	[3][HBuffSize];	///< Указатели на выборки \c HBuffSize значений фазных напряжений
